...
/*!\fn int list_unshift_sorted( LIST *list , void *ptr , int (*comparator)( void *a , void *b ) , void (*destructor)( void *ptr )  )
...
{   
   ...
   n_assert( list , n_log( LOG_ERR , "invalid list: NULL" ); return NULL );
...
int list_empty( LIST *list )
{
   ...
   n_assert( list , n_log( LOG_ERR , "list is NULL" ); return FALSE );
...
int list_empty_with_f( LIST *list ,  void (*free_fnct)( void *ptr )  )
{
   ...
   if( !list ){ n_log( LOG_ERR , "list is NULL" ); return FALSE ; }
...
{
   n_assert( (*list) , n_log( LOG_ERR , "list already destroyed" ); return FALSE );
   list_empty( (*list) );
   Free( (*list ) );
   return TRUE ;
} /* free_list( ... ) */
